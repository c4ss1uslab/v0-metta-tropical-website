  ...
  <div className="mx-auto max-w-4xl px-6 lg:px-8">
    ...
    <div className="mt-10 space-y-6 text-muted-foreground">
      ...
      <p className="font-medium leading-relaxed text-foreground">
        ...
        the sacred. Each shift is supported by capacities that help these deeper
        ways of relating become lived realities.
      </p>
    ...
    */}
    ...
    <div className="relative isolate mt-12">
      ...
      {/* ===================================================== */}
      {/* DECORATIVE IMAGE — LEFT OF SELF AND WORLD */}
      {/* ===================================================== */}
      ...
      >
        <img
          src="https://i.postimg.cc/52H5SdRg/cosmos-166365767-(1).jpg"
          alt=""
          loading="lazy"
...
>
  {/* Keep all four existing cards here, unchanged. */}
        ...
        <article
          tabIndex={0}
          className="group relative flex min-w-0 flex-col overflow-hidden bg-white p-5 shadow-[0_3px_16px_rgba(15,23,42,0.075)] outline-none md:p-7 lg:bg-white/95"
        >
    ...
    <div className="mt-20 space-y-6 text-muted-foreground">
